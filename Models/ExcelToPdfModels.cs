...
namespace ExcelToPdfConverter.Models
{
    ...
    public class WorksheetPreview
    {
        ...
        public List<InvoiceNumber> InvoiceNumbers { get; set; } = new List<InvoiceNumber>();
        ...
        public bool HasInvoiceNumbers => InvoiceNumbers.Count > 0;
        public bool HasDateRanges => DateRanges.Count > 0;
    }
    ...
    public class InvoiceNumber
    {
        ...
        public string LabelText { get; set; } = string.Empty; // "Invoice Number" text
        public string Location => $"{ColumnName}{Row}";
        public string FullInfo => $"'{LabelText}' → '{Number}' at {Location}";
    }

    // नया class: Date Range
    public class DateRange
    {
        ...
        public int Column { get; set; }
        public string ColumnName { get; set; } = string.Empty;
        public string DateRangeText { get; set; } = string.Empty; // "01-10-2025 TO 31-10-2025"
        public string Location => $"{ColumnName}{Row}";
        public string FullInfo => $"'{DateRangeText}' at {Location}";
    }
    ...
    public class PreviewModel
    {
        ...
        public string PreviewPdfBase64 { get; set; }
        public string PreviewPdfFileName { get; set; }
        public int PreviewPdfPages { get; set; }
    }

    public class PreviewPdfInfo
    {
        ...
        public string Base64Data { get; set; } // ✅ Optional now
        public string PdfUrl { get; set; } // ✅ NEW: URL for direct loading
        public string FileName { get; set; }
        public int PageCount { get; set; }
        public DateTime CreatedAt { get; set; }
        public List<PageOrderInfoWithRotation> PageOrderData { get; set; }
        public List<string> SelectedSheets { get; set; }
        public string FilePath { get; set; } // ✅ NEW: Server file path
        public List<PageOrderInfoWithRotation> CurrentPageOrder { get; set; } = new List<PageOrderInfoWithRotation>();
    }
    ...
    public class FileSelection
    {
        ...
        public bool HasInvoiceNumbers { get; set; }
        public bool HasDateRanges { get; set; }
        public List<NameError> NameErrors { get; set; } = new List<NameError>();
        public List<InvoiceDate> InvoiceDates { get; set; } = new List<InvoiceDate>();
        public List<InvoiceNumber> InvoiceNumbers { get; set; } = new List<InvoiceNumber>();
        public List<DateRange> DateRanges { get; set; } = new List<DateRange>();
